...
class _Home extends State<Home> {
  ...
  String replaceText(text) {
    ...
    if(rtMatch) {
      ...
      var httpMatch = RegExp(r'https?://[a-zA-Z0-9\-%_/=&?.]+')
          .hasMatch(result);
      if (httpMatch) {
    ...
    if(RegExp(r'https?://[a-zA-Z0-9\-%_/=&?.]+').hasMatch(data['text'])) {
      if(data['entities']['media'] != null) {
        ...
        if(data['entities']['media'].length >= 2) {
          ...
          return Image.network(data['entities']['media'][0]['media_url'],fit: BoxFit.contain);
      }
      // else {
                  ...
                  children: [
                    Flexible(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(20),
                        child: Image.network(
                            _data[index]['retweeted_status']['user']['profile_image_url_https'],
                            width: 40,
                            height: 40,
                            fit: BoxFit.fill),
                      ),
                    ...
                    Expanded(
                        ...
                        child: Column(
                            ...
                            children: [
                              Container(
                                child: Text('${_data[index]['user']['name']}さんがリツイート',
                                  style: TextStyle(
                                      fontSize: 10,
                                      color: Colors.black54,
                                      fontWeight: FontWeight.bold),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                              flex: 5,
                                              child: Text(
                                                _data[index]['entities']['user_mentions'][0]['name'],
                                                style: TextStyle(
                                                    fontSize: 13,
                                                    color: Colors.black,
                                                    fontWeight: FontWeight.bold),
                                            ...
                                            Flexible(
                                              child: Text(
                                                '@'+_data[index]['entities']['user_mentions'][0]['screen_name'],
                                                style: TextStyle(
                                                    fontSize: 11, color: Colors.black54),
                                                overflow: TextOverflow.ellipsis,
                                              ),
