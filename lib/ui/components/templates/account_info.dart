                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child:  Row(children: [
                                    Expanded(
                                      flex: 2,
                                      child: Container(child: Text('名前',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 12),),
                                    )),
                                    Expanded(
                                      flex: 10,
                                      child: Container(child:Text(data['name'],style: TextStyle(fontSize: 12)))
                                    )
                                  ],),
                                ),
                                Container(
                                  ...
                                  child:  Row(
                                    ...
                                    Expanded(
                                      flex: 2,
                                      child: Container(child: Text('自己紹介',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 12),),
                                    )),
                                    Expanded(
                                      flex: 10,
                                      child: Container(child:Text(data['description'],style: TextStyle(fontSize: 12),))
                                    )
                                  ],),
                                ),
                                Container(
                                  ...
                                  child:  Row(children: [
                                    Expanded(
                                      flex: 2,
                                      child: Container(child: Text('場所',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 12),),
                                    )),
                                    Expanded(
                                      flex: 10,
                                      child: Container(child:Text('位置情報を追加',style: TextStyle(fontSize: 12)))
                                    )
                                  ],),
                                ),
                                Container(
                                  ...
                                  child:  Row(children: [
                                    Expanded(
                                      flex: 2,
                                      child: Container(child: Text('Web',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 12),),
                                    )),
                                    Expanded(
                                      flex: 10,
                                      child: Container(child:Text('Webサイトを追加',style: TextStyle(fontSize: 12)))
                                    )
                                  ],),
                                ),
                                Container(
                                  ...
                                  child:  Row(children: [
                                    Expanded(
                                      flex: 2,
                                      child: Container(child: Text('生年月日',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 12),),
                                    )),
                                    Expanded(
                                      flex: 10,
                                      child: Container(child:Text('1999年12月28日',style: TextStyle(fontSize: 12)))
                                    )
                                  ],),
                                ),
                              ],
