...
Future<List<FollowingAndFollowerModel>> getUserFollowingApi() async {
  ...
  final res = await client.get(
    Uri.parse(
        'https://api.twitter.com/2/users/1262567497795907584/following?max_results=50&user.fields=created_at,description,public_metrics,profile_image_url,location'),
  );
